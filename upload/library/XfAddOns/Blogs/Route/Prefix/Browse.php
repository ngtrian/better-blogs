 ...
 */
class XfAddOns_Blogs_Route_Prefix_Browse implements XenForo_Route_Interface
{
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('XfAddOns_Blogs_ControllerPublic_Browse', $action, $majorNavSection);
	}
